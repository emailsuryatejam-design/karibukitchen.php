-- ============================================================
-- Pantry Planner PILOT - Database Setup
-- Import this file via phpMyAdmin into u929828006_Pantryplanner
-- ============================================================
...
-- ============================================================
-- SEED: Default Users
-- chef1/chef123, store1/store123, admin1/admin123
-- ============================================================
INSERT IGNORE INTO pilot_users (username, password_hash, name, role) VALUES
('chef1', '$2y$10$YourHashWillBeGeneratedBySetup1', 'Head Chef', 'chef'),
('store1', '$2y$10$YourHashWillBeGeneratedBySetup2', 'Store Manager', 'store'),
('admin1', '$2y$10$YourHashWillBeGeneratedBySetup3', 'Administrator', 'admin');

-- ============================================================
-- SEED: Standard Food Items (85+ industry standard)
-- ============================================================
INSERT IGNORE INTO pilot_items (name, category, unit_weight, weight_unit, portions_per_unit) VALUES
-- Poultry
...
-- ============================================================
-- Initialize kitchen stock for all items (0 portions)
-- ============================================================
INSERT IGNORE INTO pilot_kitchen_stock (item_id, portions_available)
